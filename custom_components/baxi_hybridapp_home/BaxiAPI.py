# Example from: https://github.com/vipial1/BAXI_thermostat/blob/main/custom_components/baxi_thermostat/BaxiAPI.py
...
class BaxiAPI:
    ...
    endpoints = {
        "LOGIN": "https://baxi.servitly.com/api/identity/users/login",
